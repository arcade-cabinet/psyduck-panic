...
To report an issue:
1. Open a private report via GitHub's reporting features
2. Email the maintainers directly [add contact email]
3. Reach out to any project maintainer directly
...
Thank you for helping make Psyduck Panic a welcoming community for everyone! 🎮✨
